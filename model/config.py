...
EB1_ = Encoder.Params(
    dim=80, head=8, head_dim=16, mlp_dim=128, out_dim=64, sr_ratio=4, dropout=0.3,
)
EB2 = Encoder.Params(
    dim=32, head=2, head_dim=16, mlp_dim=32, out_dim=32, sr_ratio=1, dropout=0.5,
)
EB2_ = Encoder.Params(
    dim=64, head=2, head_dim=16, mlp_dim=128, out_dim=64, sr_ratio=1, dropout=0.5,
)
...
class MP2Config(BaseConfig):
    ...
    encoder_blocks_params: List[Encoder.Params] = [EB1_, EB2_]
